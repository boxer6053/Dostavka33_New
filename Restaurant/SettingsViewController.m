...
{
    if ([segue.identifier isEqualToString:@"toLoginFromSettings"]) {
        FacebookLoginViewController *facebookLoginViewController = segue.destinationViewController;
        facebookLoginViewController.imageLinkLogin = @"https://lh6.googleusercontent.com/-Oo9ZpMcOy7I/UJOcN9NvvqI/AAAAAAAAABA/jW98WPQbroA/s572/logo.png";
        facebookLoginViewController.infoLogin = @"I like it!";
        facebookLoginViewController.linkLogin = @"http://www.matrix-soft.org/";
        facebookLoginViewController.nameLogin = @"\"Dostavka 33 \"";
    }
